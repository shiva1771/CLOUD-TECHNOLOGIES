...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_right_column">
        ...
        <div id="templatemo_content_wrapper">
        	...
        	<div id="templatemo_content">
                ...
                <h2>View DeDup Files Details </h2>
                <p><br />
</p>
		    ...
		    <table width="624" border="1" align="left">
              <tr>
				...
				<td width="161"><div align="center"><span class="style5">File Name </span></div></td>
								<td width="161"><div align="center"><span class="style5">Hash Code </span></div></td>
      	...
      	try 
	{
      		...
      		String query="select * from dedup_files"; 
...
%>
                ...
                <div class="button"><a href="StorageServerMain.jsp">Back</a></div>
